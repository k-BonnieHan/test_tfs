# -*- coding: utf-8 -*-
"""tfclassifi11_cnn_subclassing.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1uGK1GLr54PT4DH1MDT90oxFd3S0tySz3
"""
...
# -- Data를 골고루 섞어주기 위해 tf.data.Dataset.from_tensor_slices 사용 연습 ---------
import numpy as np
x = np.random.sample((5, 2))
print(x)
# dset = tf.data.Dataset.from_tensor_slices(x)  # 입력 파이프라인을 사용가능한 객체 생성
# print('dset : ', dset)
dset = tf.data.Dataset.from_tensor_slices(x).shuffle(10000).batch(3)  # 2, 3, 5
print(dset)
for a in dset:
    print(a)
#-----------------------------------------------------------------------------
...
train_accuracy = tf.keras.metrics.SparseCategoricalAccuracy()  # 정확도 계산용
# print(train_loss)
